###“指令:slotoff - 指定卡槽停机”使用说明
####指令的作用
　　使用 slotoff 指令，可以让开发板上的某个卡槽进入关机状态。
...
####指令的格式（示例）
```
http://192.168.7.170:38585/ctrl?token=3f4bffa77257d243875d0a5a80635934&amp;cmd=slotoff&amp;p1=1
```
####指令的格式（TCP方式示例）
```
